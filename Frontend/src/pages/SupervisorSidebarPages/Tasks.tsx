...
import { ArrowBigLeft, MessageSquare, Paperclip, Plus, Trash2,  X } from "lucide-react";
...
const Tasks = ({ darkMode, initialProjectId, onClose, modalOnly }: TasksProps) => {
            ...
            selectedTask && (
              <>
                <button 
                  ...
                  className={`flex items-center ml-auto mt-0 rounded-md ${darkMode ? "bg-zinc-700" : "bg-gray-100"}`}
                >
                ...
                <div className="flex justify-between items-center mt-0">
                  ...
                  <button 
                    ...
                    className={`text-sm px-2 py-1 mt-2 rounded-xl ${darkMode ? "bg-green-900 hover:bg-green-800 text-green-300" : "bg-green-100 hover:bg-green-200 text-green-800"}`}
                  >
                    Edit
                  </button>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className={`w-fit py-2 flex items-center p-4 rounded-md ${darkMode ? "bg-gray-600" : "bg-gray-100"}`}>
                    ...
                    <button
                      ...
                      className={`relative left-3/4 text-sm border rounded-xl px-2 py-2 ${
                        darkMode 
                   ...
                   <div className={`flex items-center justify-start p-3 rounded-md ${darkMode ? "bg-gray-700" : "bg-gray-100"}`}>
                     <div 
                        onClick={() => setSelectedAttachment({
                          id: selectedTask.id,
                          name: selectedTask.attachment?.name,
                          size: selectedTask.attachment?.size,
                          type: selectedTask.attachment?.type,
                      ...
                      <div className="min-w-0">
                        <div className="text-blue-600 hover:underline dark:text-blue-400 truncate block">
                          {selectedTask.attachment.name}
                        </div>
                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          {formatFileSize(selectedTask.attachment.size)} . {selectedTask.attachment.type}
                        </div>
                      </div>
                     </div>
                     <button onClick={(e) => {
                                 ...
                                 if (window.confirm ("Delete this attachment?")){
                                  handleDeleteAttachment(selectedTask.id);
                                 } 
                              }}
              ...
              {showRightPanel && selectedSubTask && (
                <div className={`w-1/4 p-6 rounded-lg ${darkMode ? "bg-gray-800" : "bg-gray-50"}`}>
                  ...
                  <div className="mb-6">
                    <h3 className="font-medium">Progress</h3>
                    <div className={`mt-1 w-32 h-2 rounded-full ${
                      darkMode 
                        ? "bg-gray-700" 
                        : "bg-gray-200"
                    }`}>
