...
import { Home, PlusCircle, SquareDashedKanban, ClipboardList, Megaphone, Settings } from "lucide-react";
import { useEffect, useState } from "react";
import { useLocation, Link } from "react-router-dom";

type PresidentSidebarProps = {
    isOpen: boolean;
    onClose?: () => void;
    darkMode: boolean;
}
...
const SIDEBAR_ITEMS = [
    { name: "Home", icon: Home, href: "/dashboard/president" },
    { name: "Create Project", icon: PlusCircle, href: "/dashboard/president/create-project" },
    { name: "Projects", icon: SquareDashedKanban, href: "/dashboard/president/projects" },
    { name: "Reports", icon: ClipboardList, href: "/dashboard/president/reports" },
    { name: "Announcements", icon: Megaphone, href: "/dashboard/president/announcements" },
    { name: "Settings", icon: Settings, href: "/dashboard/president/settings" },
];


const PresidentSidebar = ({ isOpen, onClose, darkMode }: PresidentSidebarProps) => {
